...
public class Exceptions {
	 ...
	 * 
	 * The wrapping function catches all subtypes of exception and wraps them in
	 * an exception of type {@code AutomationException}
	 * </p>
	 * 
	 * @param <T>
	 *            the input argument
	 * @param <R>The
	 *            element type of the new stream
	 * @param checked
	 ...
	 *             if the function passed in throws any exception
	 * 
	 * 
	 */
