...
public class TaskList {
	...
	protected Process getTaskListProcess() throws IOException {
	...
	public String toString() {
		String sep = "============================";
		String headers = String.format(LINE_FORMAT, "Image Name", "PID",
				"Session Name", "Session#", "Mem Usage");
		StringBuilder builder = new StringBuilder(headers);
		builder.append(sep)
				.append(" ")
				.append(sep.substring(17))
				.append(" ")
				.append(sep.substring(9))
				.append(" ")
				.append(sep.substring(17))
				.append(" ")
				.append(sep.substring(13))
				.append('\n');
	...
	public class TaskListEntry {
		...
		private TaskListEntry(String[] seperators, String line) {
			try {
				...
				this.sessionNum = Integer
						.parseInt(line.substring(start, end).trim());
				...
				String msg = String.format(format, line,
						Arrays.toString(seperators));
		...
		@Override
		public String toString() {
			return String.format(LINE_FORMAT, image, pid, sessionName,
					sessionNum, memUsage);
		}
